...
📐 **[Agentic Systems Architecture](https://github.com/carp007/agentic-systems-architecture)** — Detailed workflow diagrams, design decisions, and architecture docs for the multi-agent systems I've built. No source code — just the thinking behind the systems.
